...
<html lang="en">
	...
	<main class="container text-center">
		...
		<h5 class="mb-4 text-muted fw-bold">Demonstration || Real Life Scenario</h5>

		<!-- Buttons -->
		<div class="d-flex justify-content-center gap-3">
			<a href="pdf_create/pdf_demo.php" target="_blank" class="btn btn-primary btn-lg">demo.pdf</a>
			<a href="pdf_create/pdf_real_app.php" target="_blank" class="btn btn-success btn-lg">realApp.pdf</a>
		</div>
